    ...
    <>
      {item.title ? (
        <div
          ...
          className="relative z-0 w-full bg-[#e6e6e6] rounded-lg overflow-hidden flex flex-col items-start justify-end text-white  group  min-h-[360px]">
          ...
          />
          <span className="absolute bottom-0 left-0 w-full h-full bg-gradient-to-t to-transparent from-kerf-blue-dark/90  -z-[5]" />
        </div>
      ) : (
        <div></div>
      )}
